...
public class BestFitStorage extends StorageStrategy {
    //f. Sorts memory into ascending order based on block size, then traverses the list to find the first open block, giving me the smallest possible block to place the job.
